...
function Products() {
  ...
  const { SelectedPrice } = useSelector((state) => state.Products);
        ...
        >
          ...
          <div className="form-check d-flex justify-content-start column-gap-2 ps-2">
            <input
              ...
              id="hightolow"
              checked={SelectedPrice === "hightolow"}
              onClick={() => {dispatcher(sortSelected({type: "hightolow"})); setShowFilter(false)}}
              readOnly
            />
            <label htmlFor="hightolow">High-to-Low</label>
          </div>
          <div className="form-check d-flex justify-content-start column-gap-2 ps-2">
            <input
              ...
              id="lowtohigh"
              checked={SelectedPrice === "lowtohigh"}
              onClick={() => {dispatcher(sortSelected({type: "lowtohigh"})); setShowFilter(false)}}
              readOnly
            />
            <label htmlFor="lowtohigh">Low-to-High</label>
          </div>
